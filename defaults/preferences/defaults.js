...
pref("extensions.zotfile.wildcards.user",'{"1":"AbbName", "2": {"field": "AbbName", "operations": [{"function":"toLowerCase"}]}, "3": {"field": "date", "operations": [{"function": "exec", "regex": "\\\\b\\\\d{2}(\\\\d{2})\\\\b", "group":1}]}}');
